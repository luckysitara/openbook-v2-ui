  ...
  return (
    <div className="w-1/6 md:w-1/12 lg:w-1/6  font-raleway font-semibold border-r border-gray-800">
      <div className="flex flex-col items-center  h-screen overflow-hidden text-[#b2aacd] bg-[#1e1924]">
        ...
        <div className="w-full px-2">
          <div className="flex flex-col items-center w-full mt-3 border-t border-gray-700">
            <a
              ...
              } hover:bg-[#372f42] hover:text-[#dba2ff]`}
              href="/"
            >
              <svg
            ...
            <a
              className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-[#372f42] hover:text-[#dba2ff]"
              href="#"
            >
              <svg
                className="w-6 h-6 stroke-current"
          ...
          <div className="flex flex-col items-center w-full mt-2 border-t border-gray-700">
            ...
            <a
              className="flex items-center w-full h-12 px-3 rounded hover:bg-[#372f42] hover:text-[#dba2ff]"
              href="#"
            >
              <svg
                className="w-6 h-6 stroke-current"
            ...
            <a
              className="relative flex items-center w-full h-12 px-3  rounded hover:bg-[#372f42] hover:text-[#dba2ff]"
              href="#"
            >
              <svg
                className="w-6 h-6 stroke-current"
        ...
        <a
          className="flex items-center justify-center w-full h-16 mt-auto bg-[#372f42] hover:text-[#dba2ff] cursor-pointer"
          href="#"
        >
          <svg
            className="w-6 h-6 stroke-current"
